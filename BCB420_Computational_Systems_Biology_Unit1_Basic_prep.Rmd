...
githistory2table(git2r::commits(repo=".",path=knitr::current_input()))
...
## Task:
```{block, type="rmd-task"}
  1. Read a brief introduction to ideas about "Cargo Cult Bioinformatics".
  1. Visit the Student Wiki: Cargo_Cult_Science page (and its associated Student Wiki: Not_(quite)_Cargo_Cult_Science page) on the Student Wiki and add an example of your own that you have encountered during your studies or elsewhere[1].
